    ...
    <main className="min-h-screen bg-gradient-to-br from-yellow-300 via-pink-300 to-cyan-300 p-3 sm:p-4 md:p-8 pb-24 sm:pb-8">
      ...
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-4 sm:mb-6 md:mb-8">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-black drop-shadow">
        ...
        <footer className="mt-8 sm:mt-12 text-center text-black font-bold drop-shadow text-sm sm:text-base">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-t-4 border-black shadow-lg">
          <div className="flex justify-around items-center py-3 px-2">
            ...
            >
              ...
              <span className="text-xs font-bold">Dolan X</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center gap-1 text-purple-600 hover:text-purple-700 transition-colors"
              title="Artist X Profile"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center gap-1 text-yellow-600 hover:text-yellow-700 transition-colors"
              title="Official Website"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
